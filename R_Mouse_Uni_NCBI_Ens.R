...
#UniProt_data4_duplicatted = dplyr::filter(UniProt_data4_duplicatted, Organism_UniProt == "Mus musculus (Mouse)") # selection of mouse identyfiers
#head(UniProt_data4_duplicatted, n=10) # showing first n rows
...
####################################################################
####### joining unmatched paper / UniProt and NCBI data based on MGI IDs####
####################################################################
...
Pap_Uni_NCBI_V3 = dplyr:: left_join(Pap_Uni_NCBI_V3_unmatched2, ncbi_dataset2, by = c("MGI_ID_UniProt_clean" = "Nomenclature_ID_NCBI"), keep = TRUE, na_matches = "never") # joining the data
head(Pap_Uni_NCBI_V3, n=10) # showing first n rows
