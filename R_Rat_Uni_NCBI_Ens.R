...
Pap_Uni_NCBI = dplyr:: left_join(Pap_Uni, ncbi_dataset2, by = c("NCBI_Gene_ID_UniProt_clean" = "NCBI_GeneID"), keep = TRUE, na_matches = "never") # joining the data
...
####################################################################
####### joining unmatched paper / UniProt and NCBI data based on RGD IDs####
####################################################################
...
Pap_Uni_NCBI_V3 = dplyr:: left_join(Pap_Uni_NCBI_V3_unmatched2, ncbi_dataset2, by = c("RGD_ID_UniProt_clean" = "Nomenclature_ID_NCBI"), keep = TRUE, na_matches = "never") # joining the data
head(Pap_Uni_NCBI_V3, n=10) # showing first n rows
